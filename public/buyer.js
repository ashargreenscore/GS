                ...
                <div style="display: grid; grid-template-columns: 150px 1fr auto; gap: 1.5rem; align-items: start;">
                    ...
                    <div style="flex: 1;">
                        ...
                        <div class="order-info-box" style="display: grid; grid-template-columns: repeat(2, 1fr); gap: 0.75rem; margin-bottom: 0.75rem; padding: 0.75rem; border-radius: 8px;">
                            ...
                            <div>
                                <div class="order-detail-label profile-page-label">Seller</div>
                                <div class="order-detail-value profile-page-value">${order.seller_name}${order.seller_company ? ` (${order.seller_company})` : ''}</div>
                            </div>
                            <div>
                ...
                <div style="display: grid; grid-template-columns: 150px 1fr auto; gap: 1.5rem; align-items: start;">
                    ...
                    <div style="flex: 1;">
                        ...
                        <div class="order-info-box" style="display: grid; grid-template-columns: repeat(2, 1fr); gap: 0.75rem; margin-bottom: 0.75rem; padding: 0.75rem; border-radius: 8px;">
                            ...
                            <div>
                                <div class="order-detail-label profile-page-label">Seller</div>
                                <div class="order-detail-value profile-page-value">${request.seller_name}${request.seller_company ? ` (${request.seller_company})` : ''}</div>
                            </div>
                            <div>
