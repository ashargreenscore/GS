...
⚠️ **IMPORTANT: Use Transaction Pooler (NOT Direct Connection)**

Render and many hosting providers are IPv4-only. Supabase's Direct connection (port 5432) uses IPv6 and won't work. You MUST use Transaction Pooler (port 6543).
...
- ✅ Better for serverless/stateless applications (like Render)
- ✅ Port 6543 exclusively supports Transaction Mode (Session Mode deprecated)
